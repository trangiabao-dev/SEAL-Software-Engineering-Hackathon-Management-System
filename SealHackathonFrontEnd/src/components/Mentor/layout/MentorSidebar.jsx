    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-sm leading-5 text-white/75">
          Read-only supervision for assigned tracks, teams, topics, and
          submissions.
        </p>
      </div>
      ...
      >
        <div className="rounded-2xl bg-white/10 p-4 text-white">
          <p className="text-sm font-bold">Mentor Access</p>
          <p className="mt-1 text-xs leading-5 text-white/70">
            View-only role. Judging and team administration controls are hidden.
          </p>
        </div>
        <button
